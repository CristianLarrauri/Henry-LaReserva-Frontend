...
export default function Home() {
  ...
  async function createPlayers(teamInfo){
    ...
    let bulkPromises = [];
    let tournamentName = await axios.get(`/tournaments/${teamInfo.tournament}`);
    tournamentName = tournamentName.data.name;

    teamInfo.playerName.forEach((player, index) => {
      bulkPromises.push(axios.post('/players', {
    ...
    bulkPromises.push(axios.put(`/tournaments/quitcupos/${teamInfo.tournament}`))
