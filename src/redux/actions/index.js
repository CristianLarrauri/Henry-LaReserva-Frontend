...
export const createTeam = (payload) => {
	return async (dispatch) => {
		try {
			const info = await axios.post('https://lareserva-backend.herokuapp.com/teams', payload);
			return dispatch({
				type: CREATE_TEAM,
				payload: info.data
			});
...
export const addPoint = (id) => {
	return async (dispatch) => {
		try {
			const info = await axios.put(`https://lareserva-backend.herokuapp.com/teams/add/${id}`);
			dispatch({
				type: ADD_POINT,
				payload: info.data
			});
...
export const quitPoint = (id) => {
	return async (dispatch) => {
		try {
			const info = await axios.put(`https://lareserva-backend.herokuapp.com/teams/quit/${id}`);
			dispatch({
				type: QUIT_POINT,
				payload: info.data
			});
...
export const addGoal = (id) => {
	return async (dispatch) => {
		try {
			const info = await axios.put(`https://lareserva-backend.herokuapp.com/players/add/${id}`);
			dispatch({
				type: ADD_GOAL,
				payload: info.data
			});
...
export const quitGoal = (id) => {
	return async (dispatch) => {
		try {
			const info = await axios.put(`https://lareserva-backend.herokuapp.com/players/quit/${id}`);
			dispatch({
				type: QUIT_GOAL,
				payload: info.data
			});
...
export const deleteUser = (email) => {
	return async function (dispatch) {
		try {
			const info = await axios.delete(`https://lareserva-backend.herokuapp.com/users/${email}`);
			return dispatch({
				type: DELETE_USER,
				payload: info.data
			});
	...
	return async function (dispatch) {
		try {
			const newOrder = await axios({
				method: 'post',
				url: 'https://lareserva-backend.herokuapp.com/order',
				data: { tournamentId }
			});
			return dispatch({
				type: 'NEW_ORDER',
...
export function deleteTournament(id) {
	return async (dispatch) => {
		try {
			const info = await axios.put(
				`https://lareserva-backend.herokuapp.com/tournaments/enabled/${id}`
			);
			dispatch({
...
export function getReviews() {
	return async function (dispatch) {
		try {
			const info = await axios.get(`https://lareserva-backend.herokuapp.com/reviews`);
...
export function postReviews(payload) {
	return async function (dispatch) {
		try {
			const info = await axios.post(`https://lareserva-backend.herokuapp.com/reviews`, payload);
			return dispatch({
				type: 'POST_REVIEWS',
				payload: info.data
			});
...
export function deleteReviews(id) {
	return async function (dispatch) {
		try {
			const info = await axios.delete(`https://lareserva-backend.herokuapp.com/reviews/${id}`);
			return dispatch({
				type: 'DELETE_REVIEWS',
				payload: info.data
			});
...
export function getIdReview(id) {
	return async function (dispatch) {
		try {
			const info = await axios.get(`https://lareserva-backend.herokuapp.com/reviews/${id}`);
			return dispatch({
				type: 'GET_ID_REVIEW',
				payload: info.data
			});
...
export function getEnabledReviews() {
	return async function (dispatch) {
		try {
			const info = await axios.get('https://lareserva-backend.herokuapp.com/reviews/enabled');
			return dispatch({
...
export function getDisabledReviews() {
	return async function (dispatch) {
		try {
			const info = await axios.get('https://lareserva-backend.herokuapp.com/reviews/disabled');
			return dispatch({
...
export function reportAllowReview(id) {
	return async function (dispatch) {
		try {
			const info = await axios.put(`https://lareserva-backend.herokuapp.com/reviews/${id}`);
			return dispatch({
				type: REPORT_REVIEW,
				payload: info.data
			});
